<template>
    <div id="main">
        <div class="row m-0 pb-2 d-flex justify-content-end" id="search-sort">
            ...
            <div class="col-2 pl-0">
                <select content="Filter by block" v-tippy class="form-control form-control-sm"
                    v-model="big_search.is_block">
            ...
            <table class="table table-bordered"> <!-- table-striped -->
                ...
                <tbody>
                    <tr v-for="(manager, index) in managers" :key="index">
                        ...
                        <td class="table-cell">{{ manager.gender === 0 ? 'Male' : (manager.gender === 1 ? 'Female' :
                            'Others') }}</td>
