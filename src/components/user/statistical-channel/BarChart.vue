    ...
    <div>
        <div class="row mt-3">
            <div class="col-6 pl-0 pr-2">
                <canvas class="shadow p-2" id="barChartMessage"></canvas>
            </div>
            <div class="col-6 pr-0 pl-2">
                <canvas class="shadow p-2" id="barChartFollow"></canvas>
            </div>
            <br>
        </div>
    </div>
...
export default {
    ...
    mounted() {
        var barChartMessage = document.getElementById('barChartMessage');
        var chartMessage = new Chart(barChartMessage, {}); 
        var barChartFollow = document.getElementById('barChartFollow');
