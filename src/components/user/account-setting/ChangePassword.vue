    ...
    <div id="main">
        <div id="big">
            <div class="bigContainer">
                <button data-toggle="modal" data-target="#exampleModalChangePassword" id="openChangePassword" type="button" class="mt-4 btn-pers" ><i class="fa-solid fa-gear"></i> Change</button>
