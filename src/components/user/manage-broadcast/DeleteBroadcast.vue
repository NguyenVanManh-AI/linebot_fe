                ...
                <div class="modal fade" id="deleteBroadcast" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <h4 class="text-center text-success"><strong><i class="fa-solid fa-bars-staggered"></i>
                                    View Detail Broadcast</strong></h4><br>
                            <div class="row">
                            </div>
                            <form>
                                <div class="row">
                                    <div class="col-12 preViewMessage p-0">
                                        <div class="row font-weight-bold">
                                            <div class="col-4 text-info"><i class="fa-solid fa-user-clock"></i> Sender Name</div>
                                            <div class="col-8 text-success"> : {{ this.broadcastSelected.sender_name }}</div>
                                        </div>
                                        <div class="row font-weight-bold">
                                        ...
                                        <div class="row mb-2 font-weight-bold">
                                            ...
                                            <div class="col-8 text-success"> : {{ this.broadcastSelected.sent_at }}</div>
                                        </div>
                            ...
                            <div class="modal-footer m-0">
                                ...
                                <button type="button" :class="{'btn':true, 'btn-outline-danger' : broadcastSelected.is_delete == 0 , 'btn-outline-success' : broadcastSelected.is_delete == 1  }" @click="deleteBroadcast">
                                    <i :class="{'fa-solid':true, 'fa-trash' : broadcastSelected.is_delete == 0 , 'fa-trash-arrow-up' : broadcastSelected.is_delete == 1  }"></i>
