        ...
        onEvent('selectSimpleContent', (contentSelected) => {
            ...
            switch (contentSelected.content_type) {
                case 'text':
                    ...
                    break;
                case 'sticker':
                    this.dataSticker.content_data.packageId = contentSelected.content_data.packageId;
                    this.dataSticker.content_data.stickerId = contentSelected.content_data.stickerId;
                    break;
                case 'image':
